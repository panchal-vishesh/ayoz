...
export default function DeviceSection({ deviceCards }) {
  return (
    <section id="devices" className={`${sectionShell} ${sectionGap}`}>
      <SectionIntro
        badge="Works on all devices"
        title="One platform. Every screen."
        description="Guests order on their phone. Staff manage on a tablet. Chefs get alerts on a big kitchen screen. Everything in sync."
      />
