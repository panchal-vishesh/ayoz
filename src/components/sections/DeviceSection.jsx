...
const deviceTones = [
  'from-sky-400/18 to-brand/6',
  'from-brand/16 to-white/5',
  'from-emerald-300/12 to-sky-400/6',
]
  ...
  return (
    <section id="devices" className={`${sectionShell} ${sectionGap} pb-20 sm:pb-28`}>
      <SectionIntro
        ...
        title="A more refined interface across phones, tablets, and large operational screens."
        description="Every breakpoint is shaped to feel intentional: compact on mobile, balanced on tablet, and sharp on desktop operations views."
      />
